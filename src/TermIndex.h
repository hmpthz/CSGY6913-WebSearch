...
namespace _Index {
    ...
    public:
        ...
        */
        _Base(MemoryCounter& memcnt, LexiconIter_t& iter);
        ...
        template<typename, typename> friend class _ForwardIter;
        template<typename, uint32_t, typename> friend class _BackInserter;
    ...
    */
    ...
    public:
        ...
        _BackInserter(TermIndex_t& _r) :r(&_r) {}
