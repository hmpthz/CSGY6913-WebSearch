...
struct cTermsInfoArray {
    ...
    uint32_t n;
    cTermsInfo* arr;
    cTermsInfoArray(std::vector<IndexTermIter>& iiters, cQueryResultArray* query_res);
    ~cTermsInfoArray();
};
...
PY_API void delete_QueryResult(cQueryResultArray* query_res, cTermsInfoArray* terms_info);
PY_API void delete_all();

PY_API cTermsInfoArray* get_TermsInfo(PyObject* term_list, cQueryResultArray* query_res);
